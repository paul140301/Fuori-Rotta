...
- **News** — un job giornaliero (o il bottone "Cerca novità ora") cerca notizie locali su chiusure/sgomberi/edifici dismessi, le fa classificare da un LLM economico, e le mostra come schede da confermare: nome, categoria, riassunto, link alla fonte originale, e un bottone "Aggiungi alla mappa" che geocodifica al volo e apre il form già compilato — coordinate comprese, sempre da rivedere prima di salvare.
